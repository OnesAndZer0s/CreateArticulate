...
import org.onesandzer0s.create_articulate.block.AnchorBlock
import org.onesandzer0s.create_articulate.block.BallastBlock
import org.onesandzer0s.create_articulate.block.BalloonBlock
import org.onesandzer0s.create_articulate.block.EngineBlock
import org.onesandzer0s.create_articulate.block.FloaterBlock
...
@Suppress("unused")
object CreateArticulateBlocks {
    internal val BLOCKS = DeferredRegister.create(CreateArticulateMod.MOD_ID, Registries.BLOCK)
    ...
    val SPRUCE_SHIP_HELM =
            BLOCKS.register("spruce_ship_helm") {
                ShipHelmBlock(
                        BlockBehaviour.Properties.of()
                                .mapColor(MapColor.WOOD)
                                .strength(2.5F)
    ...
    val BIRCH_SHIP_HELM =
            BLOCKS.register("birch_ship_helm") {
                ShipHelmBlock(
                        BlockBehaviour.Properties.of()
                                .mapColor(MapColor.WOOD)
                                .strength(2.5F)
    ...
    val JUNGLE_SHIP_HELM =
            BLOCKS.register("jungle_ship_helm") {
                ShipHelmBlock(
                        BlockBehaviour.Properties.of()
                                .mapColor(MapColor.WOOD)
                                .strength(2.5F)
    ...
    val ACACIA_SHIP_HELM =
            BLOCKS.register("acacia_ship_helm") {
                ShipHelmBlock(
                        BlockBehaviour.Properties.of()
                                .mapColor(MapColor.WOOD)
                                .strength(2.5F)
    ...
    val DARK_OAK_SHIP_HELM =
            BLOCKS.register("dark_oak_ship_helm") {
                ShipHelmBlock(
                        BlockBehaviour.Properties.of()
                                .mapColor(MapColor.WOOD)
                                .strength(2.5F)
    ...
    val CRIMSON_SHIP_HELM =
            BLOCKS.register("crimson_ship_helm") {
                ShipHelmBlock(
                        BlockBehaviour.Properties.of()
    ...
    val WARPED_SHIP_HELM =
            BLOCKS.register("warped_ship_helm") {
                ShipHelmBlock(
                        BlockBehaviour.Properties.of()
                                .mapColor(MapColor.NETHER)
                                .strength(2.5F)
    ...
    val LIGHT_GRAY_BALLOON =
            BLOCKS.register("light_gray_balloon") {
                BalloonBlock(
                        BlockBehaviour.Properties.of()
    ...
    val ORANGE_BALLOON =
            BLOCKS.register("orange_balloon") {
                BalloonBlock(
                        BlockBehaviour.Properties.of()
    ...
    val YELLOW_BALLOON =
            BLOCKS.register("yellow_balloon") {
                BalloonBlock(
                        BlockBehaviour.Properties.of()
    ...
    val LIGHT_BLUE_BALLOON =
            BLOCKS.register("light_blue_balloon") {
                BalloonBlock(
                        BlockBehaviour.Properties.of()
    ...
    val PURPLE_BALLOON =
            BLOCKS.register("purple_balloon") {
                BalloonBlock(
                        BlockBehaviour.Properties.of()
    ...
    val MAGENTA_BALLOON =
            BLOCKS.register("magenta_balloon") {
                BalloonBlock(
                        BlockBehaviour.Properties.of()
    ...
    fun register() {
        ...
        VSGameEvents.registriesCompleted.on { _, _ -> makeFlammables() }
    }
    ...
    fun registerItems(items: DeferredRegister<Item>) {
        BLOCKS.forEach { items.register(it.name) { BlockItem(it.get(), Item.Properties()) } }
    }
}
