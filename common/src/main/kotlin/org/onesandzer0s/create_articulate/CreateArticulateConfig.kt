...
object CreateArticulateConfig {
        @JvmField val CLIENT = Client()
        ...
        class Server {
                ...
                @JsonSchema(
                                description =
                                                "Increases heat gained at low heat level, and increased heat decreases when at high heat and not consuming fuel"
                )
                ...
                @JsonSchema(
                                description =
                                                "Increasing this value will result in more items being able to converted to fuel"
                )
                val engineMinCapacity = 2000

                @JsonSchema(description = "Fuel burn time multiplier") val engineFuelMultiplier = 2f
                ...
                @JsonSchema(
                                description =
                                                "The amount extra that each floater will make the ship float, per kg mass"
                )
                var floaterBuoyantFactorPerKg = 50_000.0

                @JsonSchema(
                                description =
                                                "The maximum amount extra each floater will multiply the buoyant force by, irrespective of mass"
                )
                ...
                @JsonSchema(
                                description =
                                                "The max elevation speed boost gained by having extra extra balloons"
                )
                ...
                // Allow CreateArticulate controlled ships to be affected by fluid drag
                @JsonSchema(
                                description =
                                                "Allow CreateArticulate controlled ships to be affected by fluid drag"
                )
                ...
                // The amount of speed that the ship can move at when the left/right impulse button
                // is held
                // down.
                @JsonSchema(
                                description =
                                                "The maximum linear velocity at any point on the ship caused by helm torque"
                )
                var turnSpeed = 3.0

                @JsonSchema(
                                description =
                                                "The maximum linear acceleration at any point on the ship caused by helm torque"
                )
                var turnAcceleration = 10.0

                @JsonSchema(
                                description =
                                                "The maximum distance from center of mass to one end of the ship considered by " +
                ...
                @JsonSchema(
                                description =
                                                "How much inertia affects CreateArticulate ships. Max 10 = full inertia"
                )
                ...
                @JsonSchema(
                                description =
                                                "Chance for popped balloons to pop adjacent balloons, per side"
                )
                ...
                @JsonSchema(
                                description =
                                                "Whether the ship helm assembles diagonally connected blocks or not"
                )
                val diagonals = true
                ...
                @JsonSchema(
                                description =
                                                "Maximum number of blocks allowed in a ship. Set to 0 for no limit"
                )
