...
enum class WoodType(val resourceName: String) : StringRepresentable {
    ...
    val textureLocationPlanks
        get() = ResourceLocation("minecraft:block/${resourceName}_planks")
    val textureLocationLog
        get() = ResourceLocation("minecraft:block/${resourceName}_log")
